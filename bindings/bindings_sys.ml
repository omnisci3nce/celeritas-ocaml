...
type nonrec vec2 = { x : float; y : float }
type nonrec vec3 = { x : float; y : float; z : float }
type nonrec vec4 = { x : float; y : float; z : float; w : float }
type nonrec transform3d = { translation : vec3; rotation : vec4; scale : float }
